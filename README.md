...
- **nlm.plate~** - Non-linear modal plate synthesizer with Berger and von Kármán models
- **nlm.string~** - Non-linear modal string synthesizer  
- **mcs.nlm.plate~** - Multi-channel version of the plate synthesizer
- **mcs.nlm.string~** - Multi-channel version of the string synthesizer
